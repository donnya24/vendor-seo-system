  ...
  <div class="bg-white rounded-2xl p-6 shadow">
    ...
    <form method="get" class="mb-5 flex flex-col sm:flex-row gap-3 items-center justify-between">
      <div class="flex items-center gap-2">
        <label for="vendor_id" class="font-medium text-gray-700">Pilih Vendor:</label>
            ...
            <?php if(!empty($logs)): ?> 
              <?php foreach($logs as $i => $log): ?>
                <tr class="hover:bg-gray-50">
                  ...
                  <td class="p-3 text-center"><?= esc($log['business_name'] ?? '-') ?></td>
    ...
    <div class="mt-3 text-sm text-gray-500 text-left">
      Catatan: Riwayat ini menampilkan semua aktivitas vendor, bisa difilter berdasarkan vendor tertentu.
    </div>
  </div>
</main>
