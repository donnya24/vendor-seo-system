      ...
      <div class="p-6">
        <form x-ref="targetForm" @submit.prevent="submitForm" class="space-y-5">
          ...
          <div>
            ...
            <select id="vendor_id" x-model="form.vendor_id" class="block w-full rounded-lg border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 py-2 px-3 transition-colors duration-200" required>
