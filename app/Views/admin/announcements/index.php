                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gradient-to-r from-blue-600 to-indigo-700">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-center text-xs font-medium text-white uppercase tracking-wider">Publish</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php foreach(($items ?? []) as $a): ?>
                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4 text-center text-sm <?= empty($a['expires_at']) ? 'text-gray-400' : 'text-gray-600' ?>">
