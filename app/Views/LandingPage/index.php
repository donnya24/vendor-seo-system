...
<body class="antialiased overflow-x-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
      <div class="h-16 flex items-center justify-between">
        ...
        <div class="hidden md:flex items-center space-x-3">
          ...
          <a href="<?= site_url('register'); ?>" class="px-5 py-2.5 rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 text-white hover:from-blue-700 hover:to-purple-700 transition-all duration-300 transform hover:scale-105 font-medium text-sm shadow-lg shine">
            Daftar Gratis
          </a>
        </div>
      ...
      <div class="md:hidden pb-4 space-y-2" x-show="menuOpen" x-cloak
        ...
        <div class="pt-3 grid grid-cols-2 gap-3">
          ...
          <a href="<?= site_url('register'); ?>" class="text-center py-3 rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 text-white font-medium text-sm">Daftar</a>
        </div>
      </div>
    </div>
  </header>
  ...
  <section class="relative min-h-screen flex items-center overflow-hidden pt-16">
    ...
    <div class="absolute inset-0 opacity-30">
      ...
      <div class="absolute top-40 right-10 w-72 h-72 bg-purple-400 rounded-full mix-blend-multiply filter blur-3xl" style="animation-delay: 2s;"></div>
      <div class="absolute bottom-20 left-1/2 w-72 h-72 bg-pink-400 rounded-full mix-blend-multiply filter blur-3xl" style="animation-delay: 4s;"></div>
    </div>
      ...
      <div class="grid lg:grid-cols-2 gap-10 items-center">
        <div data-reveal>
          ...
          <h1 class="text-4xl md:text-5xl lg:text-6xl font-black leading-tight text-gray-900 mb-5">
            Kerja Sama <br/>
            <span class="gradient-text">Transparan</span> & <br/>
            <span class="gradient-text">Efektif</span>
          </h1>
          ...
          <div class="flex flex-wrap gap-3 mb-10">
            <a href="<?= site_url('register'); ?>" class="group relative px-6 py-3 rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold hover:from-blue-700 hover:to-purple-700 transition-all duration-300 transform hover:scale-105 shadow-2xl shine text-sm">
        ...
        <div class="hidden lg:flex justify-center items-center" data-reveal data-reveal-delay="200">
          <div class="relative">
            <div class="absolute -inset-4 bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl blur-2xl opacity-20 animate-pulse"></div>
  ...
  <!-- FEATURES -->
  <section id="features" class="section py-20 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6">
      ...
      <div class="grid md:grid-cols-3 gap-6">
        ...
        <div class="glass p-6 rounded-3xl card-hover group" data-reveal data-reveal-delay="200">
          <div class="h-14 w-14 rounded-2xl bg-gradient-to-br from-purple-500 to-purple-600 text-white grid place-content-center font-black text-2xl mb-5 transform group-hover:scale-110 group-hover:rotate-3 transition-all duration-300">
            2
          </div>
        ...
        <div class="glass p-6 rounded-3xl card-hover group" data-reveal data-reveal-delay="300">
          <div class="h-14 w-14 rounded-2xl bg-gradient-to-br from-pink-500 to-pink-600 text-white grid place-content-center font-black text-2xl mb-5 transform group-hover:scale-110 group-hover:rotate-3 transition-all duration-300">
            3
          </div>
  ...
  <section id="how" class="section py-20 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
      <div class="text-center mb-14">
        <div class="inline-block px-3 py-1 rounded-full bg-purple-100 text-purple-600 font-bold text-xs mb-3" data-reveal>🚀 MULAI DENGAN MUDAH</div>
      ...
      <div class="grid md:grid-cols-4 gap-5">
        ...
        <div class="relative p-6 rounded-3xl border-2 border-gray-200 hover:border-purple-500 transition-all duration-300 card-hover" data-reveal data-reveal-delay="200">
          <div class="absolute -top-3 left-6 px-3 py-0.5 rounded-full bg-gradient-to-r from-purple-600 to-purple-700 text-white font-bold text-xs">Langkah 2</div>
          <div class="mt-3">
            <div class="h-12 w-12 rounded-xl bg-purple-100 text-purple-600 font-black text-xl grid place-content-center mb-3">⚡</div>
        ...
        <div class="relative p-6 rounded-3xl border-2 border-gray-200 hover:border-pink-500 transition-all duration-300 card-hover" data-reveal data-reveal-delay="300">
          <div class="absolute -top-3 left-6 px-3 py-0.5 rounded-full bg-gradient-to-r from-pink-600 to-pink-700 text-white font-bold text-xs">Langkah 3</div>
          <div class="mt-3">
            <div class="h-12 w-12 rounded-xl bg-pink-100 text-pink-600 font-black text-xl grid place-content-center mb-3">📊</div>
        ...
        <div class="relative p-6 rounded-3xl border-2 border-gray-200 hover:border-green-500 transition-all duration-300 card-hover" data-reveal data-reveal-delay="400">
          <div class="absolute -top-3 left-6 px-3 py-0.5 rounded-full bg-gradient-to-r from-green-600 to-green-700 text-white font-bold text-xs">Langkah 4</div>
          <div class="mt-3">
            <div class="h-12 w-12 rounded-xl bg-green-100 text-green-600 font-black text-xl grid place-content-center mb-3">💰</div>
  ...
  <!-- TESTIMONIALS -->
  <section id="testimoni" class="section py-20 bg-gradient-to-b from-gray-50 to-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
      <div class="text-center mb-14">
        <div class="inline-block px-3 py-1 rounded-full bg-pink-100 text-pink-600 font-bold text-xs mb-3" data-reveal>💬 TESTIMONI</div>
      ...
      <div class="grid md:grid-cols-3 gap-6">
        ...
        <div class="glass p-6 rounded-3xl card-hover" data-reveal data-reveal-delay="200">
          ...
          <div class="flex items-center space-x-3">
            <img src="https://i.pravatar.cc/60?img=2" class="h-12 w-12 rounded-full ring-4 ring-purple-100" alt="">
            <div>
        ...
        <div class="glass p-6 rounded-3xl card-hover" data-reveal data-reveal-delay="300">
          ...
          <div class="flex items-center space-x-3">
            <img src="https://i.pravatar.cc/60?img=3" class="h-12 w-12 rounded-full ring-4 ring-pink-100" alt="">
            <div>
  ...
  <section id="faq" class="section py-20 bg-white">
    <div class="max-w-4xl mx-auto px-4 sm:px-6">
      <div class="text-center mb-14">
        <div class="inline-block px-3 py-1 rounded-full bg-green-100 text-green-600 font-bold text-xs mb-3" data-reveal>❓ BANTUAN</div>
  ...
  <section class="py-16 relative overflow-hidden">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
      <div class="text-center">
        <h3 class="text-2xl md:text-4xl font-black text-white mb-5" data-reveal>
          Siap Kolaborasi Lebih Efektif?
        </h3>
        <p class="text-lg text-white/90 mb-8 max-w-2xl mx-auto" data-reveal data-reveal-delay="100">
      ...
      <div class="grid md:grid-cols-4 gap-8">
        <div data-reveal class="md:col-span-1">
          ...
          <div class="flex space-x-3">
            ...
            <a href="#" class="h-9 w-9 rounded-xl bg-gray-800 hover:bg-pink-600 flex items-center justify-center transition-colors">
        ...
        <div data-reveal data-reveal-delay="200" class="md:col-span-1">
          ...
          <div class="mt-4">
            ...
            <p class="text-xs text-gray-400 mt-2 break-words">
              Jl. Puntodewo No. 2 Dsn. Baron Timur, Ds. Baron, Kec. Baron, Nganjuk 64394
            </p>
          </div>
        </div>
      </div>
  ...
  <button id="toTop" title="Kembali ke atas"
          class="fixed bottom-6 right-6 h-12 w-12 rounded-2xl bg-gradient-to-r from-blue-600 to-purple-600 text-white shadow-2xl hover:from-blue-700 hover:to-purple-700 transition-all duration-300 transform hover:scale-110 z-40 hidden">
