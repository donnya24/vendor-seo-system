...
<!-- Pastikan Alpine.js sudah dimuat di halaman utama -->
...
<div x-data="{ 
    ...
    <aside 
        class="sidebar fixed inset-y-0 left-0 w-64 bg-gradient-to-b from-blue-800 to-blue-900 text-white flex-col z-40 transform transition-transform duration-300 ease-in-out"
    ...
    <!-- Modal Konfirmasi Logout (dipindahkan di luar sidebar) -->
