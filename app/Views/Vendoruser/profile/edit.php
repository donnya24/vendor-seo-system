...
<div x-show="$store.ui.modal==='profileEdit'" x-cloak
  ...
  <div class="bg-white rounded-lg shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto" @click.away="$store.ui.modal=null">
    ...
    <?php if ($successMessage): ?>
      <div class="px-6 py-4 bg-green-50 border-b text-green-700">
        <i class="fas fa-check-circle mr-2"></i><?= esc($successMessage) ?>
        <?php if (strpos($successMessage, 'pengajuan komisi') !== false): ?>
          <div class="mt-2 p-2 bg-blue-50 border border-blue-200 rounded text-sm text-blue-700">
            <i class="fas fa-bell mr-2"></i>
            <strong>Notifikasi telah dikirim!</strong> Pengajuan komisi Anda telah dikirim ke tim Admin dan SEO untuk verifikasi.
          </div>
        <?php endif; ?>
      </div>
    <?php endif; ?>
